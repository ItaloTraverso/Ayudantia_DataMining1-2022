---
title: "Parte 3 Metodo Bayesiano"
...
```{r cargando datos}
setwd("D:/Users/Italo/Documents/Italo Felipe/UAI/Semestre 1-2022/Mineria de Datos/Ayudantia_DataMining1-2022/AyudantiaProyecto2/Parte 3")
...
```{r}
titanictrain <- read.csv("train.csv") %>%  as.data.frame()
titanictest <- read.csv("test.csv") %>% as.data.frame()
